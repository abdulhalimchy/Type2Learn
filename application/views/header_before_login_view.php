	...
	<nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top">
		...
		<div id="navb" class="navbar-collapse collapse hide">
			...
			<ul class="nav navbar-nav ml-auto">
				<li class="nav-item">
					<a class="nav-link" href="<?php echo base_url();?>signup"><span class="fas fa-user"></span> Sign up</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?php echo base_url();?>signin"><span class="fas fa-sign-in-alt"></span>Sign in</a>
				</li>
			</ul>
		</div>
	</nav>	
